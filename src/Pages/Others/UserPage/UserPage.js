...
const UserPage = () => {
    ...
    return (
        <div className='flex bg-white dark:bg-slate-900 justify-center'>
            <div className="flex my-48 flex-col justify-center max-w-xs p-6 shadow-lg border rounded-xl sm:px-12 text-gray-800">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl text-gray-800 dark:text-white font-semibold sm:text-2xl">{user?.uid ?

                            <span>{user.displayName}</span>
                            :
                            <span>Name Not Found</span>
                        }</h2>
                        <p className="px-5 text-xs sm:text-base dark:text-gray-400">{user?.uid ?
                            <span>{user.email}</span>
                            :
                            <span>Not Allowed To Show Email</span>
                        }</p>
                    </div>
