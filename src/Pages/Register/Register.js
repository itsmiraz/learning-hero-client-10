...
const Register = () => {
    ...
    return (
        <div className='flex  bg-white dark:bg-slate-900   justify-center py-10'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-white dark:bg-slate-900  border border-teal-200 shadow-2xl text-gray-800">
                <h1 className="text-2xl font-bold text-teal-600 text-center">Register</h1>
                <form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        <label htmlFor="name" className="block dark:text-white  text-slate-800 font-semibold">Full Name</label>
                    ...
                    <div className="space-y-1 text-sm">
                        <label htmlFor="photourl" className="block dark:text-white  text-slate-800 font-semibold">Photo URL</label>
                    ...
                    <div className="space-y-1 text-sm">
                        <label htmlFor="email" className="block dark:text-white  text-slate-800 font-semibold">Email</label>
                    ...
                    <div className="space-y-1 text-sm">
                        <label htmlFor="password" className="block dark:text-white  text-slate-800 font-semibold">Password</label>
